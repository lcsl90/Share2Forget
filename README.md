...
- ASP.NET Core 8 Minimal API + SignalR – **ohne einzige NuGet-Abhängigkeit**
- Vanilla-JS-Frontend, SignalR-Browser-Client liegt lokal bei (läuft komplett offline im LAN)
